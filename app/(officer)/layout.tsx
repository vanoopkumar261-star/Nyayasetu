...
import { LayoutList, User, LogOut, Loader2, Menu, X } from 'lucide-react';
...
export default function OfficerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: '/officer', label: 'Queue', icon: LayoutList },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-5 border-b border-gray-100">
            ...
            <span className="text-xs text-indigo-600 font-medium">Officer Portal</span>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400 truncate">
                  {user.department_id ? DEPARTMENT_NAMES[user.department_id] || user.department_id : 'No Dept'}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="lg:hidden bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3">
          ...
          <h1 className="text-sm font-semibold text-gray-900">Officer Portal</h1>
        </div>
